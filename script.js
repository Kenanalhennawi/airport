...
const operationsGuideData = [
    ...
    },
    {
        ...
        ssrRows: [
            ...
            ["BAGB / BAGL / BAGX / BUPL / BUPX / BUPZ / BUPD / BUPE", "Baggage Upgrade SSR Codes", "Website, Contact Centre, SPRINT; Travel Shop where eligible", "Use baggage upgrade cut-off: 6h existing booking, 2h new booking/modification where allowed; UAE Travel Shop D > 4", "Baggage upgrade", "Dynamic by origin / destination. KRT example: BAGX 40kg included, BUPD 50kg AED 100, BUPE 60kg AED 200.", "Depends eligibility", "BAGB adds 20kg. BAGL adds 30kg. BAGX adds 40kg. BUPL adds 10kg to existing 20kg. BUPX adds 20kg to existing 20kg. BUPZ adds 10kg to existing 30kg. BUPD 50kg. BUPE 60kg. Always upgrade on top of existing baggage SSR; do not cancel/refund existing baggage SSR just to reprice. Example: BAGB + BUPL passenger requesting 40kg should add BUPZ, not cancel BUPL to add BUPX."],

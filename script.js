...
const operationsGuideData = [
    ...
    },
    {
        ...
        ssrRows: [
            ["PETC", "Falcon", "Contact Centre, Salesforce, Supervisor / FS, Reservations Support", "More than 48h before departure", "Approval request", "Airport handling charge per falcon + seat/fare handling as advised by Res Support", "Yes", "Create unpaid booking if more than 48h before departure. Add falcon as First name Falcon and last name as primary passenger last name. Add SSR PETC for airport handling charge. Not a confirmation until approved. Prior approval is mandatory. Valid health certificate required. Every falcon carried is charged one seat. Airport handling charges are non-refundable. Any falcon arriving into DXB must be carried in a box only."],
            ...
            ["SPEQ", "Sporting Equipment 160-189cm", "Contact Centre / SPRINT / Supervisor or FS", "At least 24h before departure; Supervisor / FS may check possibility up to 12h if limit not reached", "Special baggage", "AED 150 per item per flight / sector", "Restricted / capacity controlled", "Free if within hand baggage dimensions or checked baggage dimensions up to 159cm. Add SPEQ per leg for 160-189cm by L+W+H. Max 32kg per item; no sporting equipment over 32kg. Max 10 equipment per flight unless Special Handling approval. Passenger must arrive at least 2h before departure. Handling fee refundable up to 24h before departure; within 24h non-refundable and non-transferable."],
            ["SPEX", "Sporting Equipment 190-350cm", "Contact Centre / SPRINT / Supervisor or FS", "At least 24h before departure; Supervisor / FS may check possibility up to 12h if limit not reached", "Special baggage", "AED 270 per item per flight / sector", "Restricted / capacity controlled", "Free if within hand baggage dimensions or checked baggage dimensions up to 159cm. Add SPEX per leg for 190-350cm by L+W+H. Max 32kg per item; no sporting equipment over 32kg. Beyond 350cm, pole vaults, javelins, and hang gliders require pre-authorization 48h before departure and additional charges. Passenger must arrive at least 2h before departure. Handling fee refundable up to 24h before departure; within 24h non-refundable and non-transferable."],
            ["WEAP / SPEX", "Sporting Weapons", "Contact Centre, letstalk, Supervisor / FS, Security approval", "96h before travel", "Security approval", "WEAP AED 300 per passenger per sector + applicable SPEX charge", "Yes", "Sporting weapons are subject to pre-authorization 96h before departure and Dubai Police approval fee. Customer must email documents first or provide case number. Sporting weapons need WEAP plus SPEX charges where applicable. Do not confirm without security approval."],
            ["BAG / BUP*", "Baggage / Baggage Upgrade", "Website / Manage Booking, Contact Centre, Travel Shop, OLCI, SPRINT, Airport where applicable", "Existing booking: 6h before departure. New booking / modification: Website 2h; Contact Centre up to D-2 via Shift In Charge, subject to availability.", "Ancillary service", "Dynamic by origin / destination and subject to availability", "Usually no", "Passengers with no baggage allowance, or who want to upgrade baggage allowance, can add subject to availability through flydubai Web or Contact Centre. Agent can add/upgrade if applicable through SPRINT. Baggage upgrade is multi-channel, not airport-only. OLCI supported for eligible bookings. Moving/cancellation of optional extras such as baggage or seat is allowed only 24h prior to departure."],
            ["BAGB / BAGL / BAGX / BUPL / BUPX / BUPZ / BUPD / BUPE", "Baggage Upgrade SSR Codes", "Website, Contact Centre, Travel Shop, OLCI, SPRINT as eligible", "Use baggage upgrade cut-off: 6h existing booking, 2h new booking/modification where allowed", "Baggage upgrade", "As per system / route. KRT example: BAGX 40kg included, BUPD 50kg AED 100, BUPE 60kg AED 200.", "Depends eligibility", "BAGB adds 20kg. BAGL adds 30kg. BAGX adds 40kg. BUPL adds 10kg to existing 20kg. BUPX adds 20kg to existing 20kg. BUPZ adds 10kg to existing 30kg. BUPD 50kg. BUPE 60kg. Always upgrade on top of existing baggage SSR; do not cancel/refund existing baggage SSR just to reprice."],
